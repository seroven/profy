            ...
            SettingsSection(
              ...
              children: [
                SettingsTile(
                  ...
                  onTap: () => context.push('${ConfiguracionScreen.routePath}/perfil'),
                ),
                SettingsTile(
                  ...
                  onTap: () =>
                      context.push('${ConfiguracionScreen.routePath}/usuario'),
                ),
                SettingsTile(
                  ...
                  onTap: () => context
                      .push('${ConfiguracionScreen.routePath}/contrasena'),
                ),
              ],
            ),
            const SizedBox(height: 18),
            SettingsSection(
              ...
              children: [
                SettingsTile(
                  ...
                  onTap: () => context
                      .push('${ConfiguracionScreen.routePath}/preferencias'),
                ),
              ],
            ),
            const SizedBox(height: 18),
            ...
            SettingsSection(
              ...
              children: [
                SettingsTile(
                  ...
                  onTap: () => context
                      .push('${ConfiguracionScreen.routePath}/medios-pago'),
                ),
              ],
            ),
            const SizedBox(height: 18),
